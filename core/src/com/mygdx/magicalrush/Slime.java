...
public class Slime
{
    ...
    // Animación
    private Animation animacionSalto;    //Salto
    private float timerAnimacion;   // tiempo para calcular el frame
    public boolean lLeft = true; //Esta viendo hacia la izquierda
    ...
    public void render(SpriteBatch batch) {
        ...
        switch (estadoMovimiento) {
            ...
            case MOV_IZQUIERDA:
                ...
                TextureRegion region = (TextureRegion) animacionSalto.getKeyFrame(timerAnimacion);
                // Dirección correcta
            ...
            case QUIETO:
                ...
                if (estadoMovimiento==EstadoMovimiento.QUIETO && lLeft == false)
                {
                    if (!regionq.isFlipX()) {
                ...
                if (estadoMovimiento==EstadoMovimiento.QUIETO && lLeft == true)
                {
                    if (regionq.isFlipX()) {
                        regionq.flip(true,false);
                        lLeft=true;
